...
public abstract class Giocatore implements Serializable {
	...
	public void setCarteSulTavolo(Carta carta){
		...
		/*
		 * La prima carta nella struttura sarà sicuramente la carta coperta, 
		 * quindi il punteggioCoperto sarà uguale a quello
	...
	private void sommaPunti(Carta carta){
		...
		if(carteSulTavolo.size() == 0 || (carteSulTavolo.size() > 0 && haMatta() == -1) )
		{
			 ...
			 * quindi il punteggio di quest'ultima sarà sommato al punteggio totale
			 */
		...
		else
		{
			 ...
			 * 	3. viene determinato il valore che dovrà assumere la matta 
	...
	/*
	 * Determina il punteggio che dovrà assumere la matta
	...
	private double calcolaPunteggioMatta(){
		 ...
		 * la matta può assumere valori interi compresi tra 1 e 7.
